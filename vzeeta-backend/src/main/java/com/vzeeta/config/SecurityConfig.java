...
import com.vzeeta.shared.security.JwtAuthFilter;
import com.vzeeta.shared.security.MustChangePasswordFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        var auth = http
                ...
                .authorizeHttpRequests(a -> {
                    ...
                    if (swaggerUiEnabled) {
                        a.requestMatchers("/swagger-ui/**", "/api-docs/**", "/swagger-ui.html").permitAll();
                    }
